...
* The VNC option enables viewing an entire Ubuntu Desktop within your browser. Useful in case you are running this project on a local machine. Refer [VNC setup](howToVNC.md) for details and configuration. **This is the recommended method for the ASD lab.**
